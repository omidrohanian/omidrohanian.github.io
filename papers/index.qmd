...
This publication record spans language modelling, biomedical and clinical NLP, efficient models, and multimodal AI. For a broader view of my citation profile, see <a href="https://scholar.google.co.uk/citations?user=dwWwU0UAAAAJ&hl=en">Google Scholar</a>.

<div class="featured-paper-card">
  <span class="featured-paper-badge">Accepted · COLM 2026</span>
  <span class="featured-paper-label">Vision-language model interpretability</span>
  <h3><a href="https://arxiv.org/abs/2604.09364">Arbitration Failure, Not Perceptual Blindness: How Vision-Language Models Resolve Visual-Linguistic Conflicts</a></h3>
  <p class="featured-paper-authors">Farhad Nooralahzadeh, <strong>Omid Rohanian</strong>, Yi Zhang, Jonathan Fürst, and Kurt Stockinger</p>
  <p class="featured-paper-summary">The paper examines cases in which vision-language models appear to encode the relevant visual evidence yet still answer according to conflicting linguistic priors. It investigates where this arbitration failure arises.</p>
  <div class="featured-paper-actions">
    <a class="featured-paper-action" href="https://arxiv.org/abs/2604.09364">Paper</a>
    <a class="featured-paper-action" href="https://openreview.net/forum?id=o3pc99Q3Mi">OpenReview</a>
    <a class="featured-paper-action" href="https://colmweb.org/">COLM 2026</a>
  </div>
</div>
...
- Nooralahzadeh, F., **Rohanian, O.**, Zhang, Y., Fürst, J., & Stockinger, K. (2026). [Arbitration failure, not perceptual blindness: How vision-language models resolve visual-linguistic conflicts](https://arxiv.org/abs/2604.09364). Accepted at the Conference on Language Modeling (COLM 2026). [OpenReview](https://openreview.net/forum?id=o3pc99Q3Mi), [COLM 2026](https://colmweb.org/)

### 2025

- Nouriborji, M., Rohanian, M., **Rohanian, O.** (2025). Improving recursive transformers with mixture of LoRAs. *arXiv preprint arXiv:2512.12880*. https://arxiv.org/abs/2512.12880
